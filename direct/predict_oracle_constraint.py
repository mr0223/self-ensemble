...
def main():
    ...
    predict_input_path = f"predict_input/b{return_num}.{data_type}.{output_ext}.csv"
    constraint_path_majority = f"constraint/_both/b{return_num}.majority.{data_type}.{output_ext}.pkl"
    constraint_path_majority_p = f"constraint/_positive/b{return_num}.majority.{data_type}.{output_ext}.pkl"
    constraint_path_majority_n = f"constraint/_negative/b{return_num}.majority.{data_type}.{output_ext}.pkl"
    # constraint_path_union = f"constraint/_both/b{return_num}.union.{data_type}.{output_ext}.pkl"
