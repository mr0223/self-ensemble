...
def main():
    ...
    parser.add_argument("--data_type", type=str, help="valid or test")
    parser.add_argument("--output_file", type=str, help="output file")

    parser.add_argument("--constraint", type=str, help="constraint file(pickle)")
    ...
    input_lines = datasets[args.data_type]["document"]

    with open(args.constraint, "rb") as f:
